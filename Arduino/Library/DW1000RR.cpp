...
*/
// SPI settings
const SPISettings DW1000RRClass::_fastSPI = SPISettings(16000000L, MSBFIRST, SPI_MODE0);
const SPISettings DW1000RRClass::_slowSPI = SPISettings(2000000L, MSBFIRST, SPI_MODE0);
