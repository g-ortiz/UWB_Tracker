...
#ifndef _DW1000DeviceFR_H_INCLUDED
#define _DW1000DeviceFR_H_INCLUDED
...
class DW1000DeviceFR;

class DW1000DeviceFR {
public:
	//Constructor and destructor
	DW1000DeviceFR();
	DW1000DeviceFR(byte address[], byte shortAddress[]);
	DW1000DeviceFR(byte address[], boolean shortOne = false);
	~DW1000DeviceFR();
	...
	boolean isAddressEqual(DW1000DeviceFR* device);
	boolean isShortAddressEqual(DW1000DeviceFR* device);
