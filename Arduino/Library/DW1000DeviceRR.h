...
#ifndef _DW1000DeviceRR_H_INCLUDED
#define _DW1000DeviceRR_H_INCLUDED

#include "DW1000Time.h"
#include "DW1000MacRR.h"

class DW1000MacRR;
class DW1000DeviceRR;
...
public:
	...
	DW1000DeviceRR();
	DW1000DeviceRR(byte address[], byte shortAddress[]);
	DW1000DeviceRR(byte address[], boolean shortOne = false);
	~DW1000DeviceRR();
	...
	boolean isAddressEqual(DW1000DeviceRR* device);
	boolean isShortAddressEqual(DW1000DeviceRR* device);
