...
#ifndef _DW1000DeviceFL_H_INCLUDED
#define _DW1000DeviceFL_H_INCLUDED

#include "DW1000Time.h"
#include "DW1000MacFL.h"

class DW1000MacFL;
class DW1000DeviceFL;
...
public:
	...
	DW1000DeviceFL();
	DW1000DeviceFL(byte address[], byte shortAddress[]);
	DW1000DeviceFL(byte address[], boolean shortOne = false);
	~DW1000DeviceFL();
	...
	boolean isAddressEqual(DW1000DeviceFL* device);
	boolean isShortAddressEqual(DW1000DeviceFL* device);
