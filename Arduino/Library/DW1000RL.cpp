...
*/
// SPI settings
const SPISettings DW1000RLClass::_fastSPI = SPISettings(20000000L, MSBFIRST, SPI_MODE0);
const SPISettings DW1000RLClass::_slowSPI = SPISettings(3000000L, MSBFIRST, SPI_MODE0);
